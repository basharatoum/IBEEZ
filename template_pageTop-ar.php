...
include("db_conx.php");
$envelope = '';
$loginLink = '<a href="login-ar.php">  تسجيل الدخول</a>  <a href="signup-ar.php"> سجل هنا </a>';
if($user_ok == true) {
    ...
    if ($numrows == 0) {
		$envelope = '<a href="notifications.php" title="Your notifications and friend requests">لا يوجد اشعارات جديدة</a>';
    } else {
		$envelope = '<a href="notifications.php"  title="اشعارات جديدة">اشعارات جديدة</a>';
	}
    $loginLink = '<a href="user.php?u='.$log_username.'"  >'.$log_username.'</a> <a href="logout.php"> تسجيل الخروج</a>';
} 
include("db_conx.php");
