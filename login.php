...
<div style="width:100%; height:80px;"> </div>
  ...
  <!-- LOGIN FORM -->
  <form id="loginform" onsubmit="return false;" style="width:300px; height:auto; margin-left:auto; color:hsla(0,0%,0%,1.00); font-family:Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif;	 margin-right:auto;">
 ...
 <!--   <a style="text-decoration:none; color:006ab8;" href="forget_pass.php">Forgot Your Password?</a>
    --><button  style="border: none; color: #FFF; background-color: #4cc87f; padding: 125px; bottom: 0px; margin-top:10px; padding-top: 10px; padding-bottom: 20px; border-radius: 40px;" id="loginbtn" onclick="login()">Log In</button> 
