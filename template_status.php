...
if($isOwner == "yes"){
	...
	$status_ui = '<textarea  style="width:700px; margin-left:auto; margin-right:auto; border-radius:20px;" id="statustext" onkeyup="statusMax(this,250)" placeholder="Hi '.$log_username.', say something to '.$u.'"></textarea>';
	$status_ui .= '<button style="border:none; color:#FFF; background-color:#4cc87f; border-radius:20px; margin-left:10px;  padding:40px;  padding-top:20px; padding-bottom:20px;" id="statusBtn" onclick="postToStatus(\'status_post\',\'c\',\''.$u.'\',\'statustext\')">Post</button>';
}
?><?php 
